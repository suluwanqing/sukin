...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  props: {
    ...
    stackExtractedOffset: { default: 60 },
    ...
    const getItemStyle = (index) => {
      switch (props.mode) {
        ...
        case "stack":
          ...
          let transformStack = `rotate(calc(${iValue} * var(--su-card-stack-rotate))) translateX(calc(${iValue} * var(--su-card-stack-offset)))`;
          let zIndexStack = `calc(50 - abs(${iValue}))`;
          if (index === activeIndex.value) {
            transformStack += ` translateY(calc(-1 * var(--su-stack-extracted-offset))) scale(1.08)`;
            zIndexStack = "200";
          }
          return { transform: transformStack, zIndex: zIndexStack };
        default:
          return {};
      }
    };
        ...
        createElementVNode("div", {
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(props.items, (item, index) => {
            return openBlock(), createElementBlock("div", {
              ...
              onMouseenter: ($event) => unref(handleCardHover)($event, item, index, emit)
            }, [
              createElementVNode("div", {
...
const Icard = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-35d6642a"]]);
